...
public class CommInfoDto {
	...
	public CommInfoDto(int no, String shopName, String localName, String code1, String codeName1, String code2,
	...
	public String toString() {
		return "CommInfoDto [no=" + no + ", ShopName=" + ShopName + ", LocalName=" + LocalName + ", code1=" + code1
